  ...
  return (
    <div className="space-y-1">
      <button
        ...
        className={cn(
          'flex items-center gap-2 w-full px-2.5 py-1.5 rounded-lg text-xs transition-colors hover:bg-accent text-left',
      ...
      {open && children && <div className="pl-6 space-y-1 border-l border-border ml-4">{children}</div>}
    </div>
  );
}
    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pb-3 border-b border-border">
        <div className="p-2.5 bg-muted rounded-lg border border-border">
          <span className="text-[10px] text-muted-foreground block">Total Pages</span>
          <span className="text-lg font-bold text-blue-400">{summary.page_count}</span>
        </div>
        <div className="p-2.5 bg-muted rounded-lg border border-border">
          <span className="text-[10px] text-muted-foreground block">Forms Discovered</span>
          <span className="text-lg font-bold text-amber-400">{summary.form_count}</span>
        </div>
        <div className="p-2.5 bg-muted rounded-lg border border-border">
          <span className="text-[10px] text-muted-foreground block">Interactive Buttons</span>
          <span className="text-lg font-bold text-sky-400">{summary.button_count}</span>
        </div>
        <div className="p-2.5 bg-muted rounded-lg border border-border">
          <span className="text-[10px] text-muted-foreground block">Input Fields</span>
