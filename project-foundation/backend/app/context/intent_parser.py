...
class HybridIntentParser(LoggerMixin):
    ...
    async def parse(
        ...
        *,
        ...
        Args:
            ...
            model: Optional backend-approved model id for LLM augmentation.
        ...
        if should_use_llm and self._llm:
            llm_part = await self._try_llm(deterministic.redacted_text, model=model)
    ...
    async def _try_llm(self, redacted_text: str, model: str | None = None) -> LLMIntentSchema | None:
        """
