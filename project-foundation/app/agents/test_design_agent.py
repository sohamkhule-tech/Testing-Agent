...
- Identify the top high-risk areas and mark at least 30% of scenarios as regression candidates."""
        ...
        renumber_scenario_ids(
            ...
            all_scenarios=all_raw_scenarios if isinstance(all_raw_scenarios, list) else [],
            ...
            for sc in mod.get("scenarios", []):
                ...
                scenario = TestScenario(
                    metadata=ScenarioMetadata(
                        ...
                        priority=_safe_str(meta.get("priority", "medium")),
                        category=_safe_str(meta.get("category", "functional")),
                        ...
                        risk_level=_safe_str(meta.get("risk_level", "medium")),
                    ),
